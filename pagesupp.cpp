...
#include "gdialog.h"
QStringList pagesupp::getTeamNamesFromDatabase() {
    QStringList teams;
    QSqlQuery query;
...
void pagesupp::setupTable()
{
    ...
    model->setHeaderData(8, Qt::Horizontal, tr("Date Naissance"));
    model->setHeaderData(7, Qt::Horizontal, tr("Equipe"));
...
void pagesupp::refreshTable()
{
    model->select();
    ui->tableView->resizeColumnsToContents();
}

void pagesupp::clearForm()
{
...
/*void pagesupp::on_ajouter_clicked()
{
...
void pagesupp::on_annuler_clicked()
{
    clearForm();
}

void pagesupp::on_brecherche_clicked()
{
...
void pagesupp::on_supprimer_clicked()
{
...
void pagesupp::on_modifier_clicked()
{
    if(selectedId == -1) {
...
void pagesupp::on_tableView_clicked(const QModelIndex &index)
{
...
void pagesupp::on_generatePdf_clicked()
{
...
void pagesupp::on_statButton_clicked()
{
...
void pagesupp::on_joueur_clicked()
{
    hide();
...
void pagesupp::on_match_clicked()
{
    hide();
    MainWindow *Mainw;
...
void pagesupp::on_billets_clicked()
{
    hide();
    gdialog *Pagebillet;
